...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Evento.categoria'
        db.add_column('contenido_evento', 'categoria', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenido.CategoriaEvento']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Evento.categoria'
        db.delete_column('contenido_evento', 'categoria_id')
    ...
    models = {
        ...
        'contenido.evento': {
            ...
            'categoria': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenido.CategoriaEvento']"}),
            'contenido': ('django.db.models.fields.TextField', [], {}),
        ...
        'contenido.noticia': {
            ...
            'contenido': ('django.db.models.fields.TextField', [], {}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 23, 34, 42, 24076)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenido.publicacion': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 23, 34, 42, 27913)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenido.rinconliturgico': {
            ...
            'contenido': ('django.db.models.fields.TextField', [], {}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 23, 34, 42, 26989)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '250', 'db_index': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
