...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RinconLiturgico.categoria'
        db.add_column('contenido_rinconliturgico', 'categoria', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenido.CategoriaRincon']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RinconLiturgico.categoria'
        db.delete_column('contenido_rinconliturgico', 'categoria_id')
    ...
    models = {
        ...
        'contenido.noticia': {
            ...
            'contenido': ('django.db.models.fields.TextField', [], {}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 0, 9, 5, 744803)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenido.publicacion': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 0, 9, 5, 747111)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'contenido.rinconliturgico': {
            ...
            'contenido': ('django.db.models.fields.TextField', [], {}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 25, 0, 9, 5, 746414)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '250', 'db_index': 'True'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '200'})
        },
