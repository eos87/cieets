...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Musica.portada'
        db.add_column('multimedia_musica', 'portada', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Musica.portada'
        db.delete_column('multimedia_musica', 'portada')
    ...
    models = {
        ...
        'multimedia.musica': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 3, 22, 19, 57, 143667)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
